...
Added heal timer cheat. When the player takes damage, start a user-defined interval time that will fully heal the player when finished. Timer is reset when taking additional damage.
